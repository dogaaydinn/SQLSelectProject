...
SELECT *
FROM employees
WHERE employees.first_name = 'Hilari';
...
SELECT *
FROM employees
WHERE employees.first_name = 'Denis' and gender = 'M';
...
SELECT *
FROM employees
WHERE employees.last_name = 'Reistad' and gender = 'F';
...
SELECT *
FROM employees
WHERE employees.first_name= 'Denis' or employees.first_name= 'Elvis';
...
SELECT *
FROM employees
WHERE employees.first_name= 'Kellie' or employees.first_name= 'Aruna';
...
SELECT *
FROM employees
WHERE employees.first_name LIKE ('Mar%');
...
SELECT *
FROM employees
WHERE employees.first_name LIKE ('Ar%');
...
SELECT DISTINCT employees.gender
    FROM employees;
...
SELECT DISTINCT COUNT(*) AS Names_Counts
FROM employees
GROUP BY first_name
ORDER BY first_name;
